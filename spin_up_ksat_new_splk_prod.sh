docker_vars_filename="ksat_new_environment.yml"
...
### tear down commands
#ansible-playbook playbooks/2_teardown_linux_containers.yml --extra-var "docker_vars_file=ksat_new_environment.yml"
